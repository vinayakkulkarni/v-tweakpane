...
**v-tweakpane** (`v-tweakpane`) -- Tweakpane for Vue.
...
v-tweakpane/
├── src/
│   ├── components/     # VTweakpane component
...
|-----------------------------------|----------------|
| `vue`                             | peer           |
| `tweakpane`                       | peer + runtime |
| `@tweakpane/plugin-essentials`    | peer + runtime |
